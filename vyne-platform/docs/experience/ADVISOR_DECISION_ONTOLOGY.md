...
> **Question → Decision → Decision family → Consulting framework (the VYNE Method) → Assessment
> module (a Practice-Transition-Assessment area) → Content type → AI → Report.**

**Governing principle:** VYNE's *research universe is open* and *no destination is the default*; this
ontology maps **decisions**, not a marketplace. Each decision can conclude in favor of any legitimate
outcome — including **stay** and **wait**.
