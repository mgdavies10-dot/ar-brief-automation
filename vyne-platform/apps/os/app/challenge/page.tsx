...
/**
 * MFA challenge at sign-in (§4.1 "MFA step when enrolled"): an aal1 session
 * with a verified factor gets no app surface until the code is verified
 * (middleware-enforced). Client component for graceful retry.
 */
